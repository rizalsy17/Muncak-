  ...
  return (
    <div className="container mt-10 mx-auto min-h-screen px-4 sm font-light:px-6 lg:px-8">
      ...
      <div className="mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4 text-darkText">
          <div className="rounded p-4 flex flex-col items-center">
            ...
            <p className="text-sm font-light">Politeknik Negeri Malang</p>
          </div>
          <div className="rounded p-4 flex flex-col items-center">
            <div className="avatar avatar-ring-primary avatar-xl w-24 h-24 mb-4 avatar-ring-error">
              <img
          ...
          <div className="rounded p-4 flex flex-col items-center">
            ...
            <p className="text-sm font-light">Universitas Brawijaya</p>
          </div>
        </div>
      </div>
    </div>
